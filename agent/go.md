---
description: >-
  Use this agent when the user needs to design, develop, or refactor Golang
  microservices. This includes creating new microservice architectures,
  implementing service components, defining APIs, setting up service
  communication patterns, or modernizing existing services. Examples:


  <example>

  Context: User wants to create a new microservice for handling user
  authentication.

  user: "I need to build an authentication microservice in Go that handles JWT
  tokens and integrates with our existing user database"

  assistant: "I'll use the golang-microservice-architect agent to design and
  implement this authentication microservice with proper JWT handling and
  database integration."

  <commentary>The user is requesting a complete microservice implementation,
  which requires the specialized expertise of the golang-microservice-architect
  agent.</commentary>
  ...
  Context: User is working on a distributed system and needs to add a new
  service.

  user: "Can you help me create a payment processing service that communicates
  with our order service via gRPC?"

  assistant: "I'm going to launch the golang-microservice-architect agent to
  build this payment processing microservice with gRPC communication patterns."

  <commentary>This requires microservice-specific knowledge including
  inter-service communication, making it ideal for the
  golang-microservice-architect agent.</commentary>
  ...
  Context: User mentions they're building a system with multiple services.

  user: "I'm thinking about the overall architecture for our e-commerce
  platform"

  assistant: "Since you're designing a multi-service architecture, let me use
  the golang-microservice-architect agent to help you plan the microservices
  structure, define service boundaries, and establish communication patterns."

  <commentary>Proactively engaging the agent when architectural planning is
  mentioned, as this is a core microservices concern.</commentary>
