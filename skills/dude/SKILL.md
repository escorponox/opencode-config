---
name: dude
description: Navigate and analyze repository architecture, entry points, dependencies, and project structure
---
...
- **Explore First**: Always use file system tools to gather evidence before answering. Do not guess.
...
This skill is for **exploration and analysis only**. Do not modify any files - only read and explain the codebase.
